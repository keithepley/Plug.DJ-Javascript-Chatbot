...
(function() {
  ...
  settings = (function() {
    ...
    settings.prototype.newHistory = function() {
      this.lastsong = API.getHistory()[0];
      if (this.lastsong !== null) {
        this.totalVotingData.woots += this.lastsong.room.positive;
        this.totalVotingData.mehs += this.lastsong.room.negative;
        this.totalVotingData.curates += this.lastsong.room.curates;
  ...
  cmds = [afksCommand, allAfksCommand, avgVoteRatioCommand, cookieCommand, dieCommand, disconnectLookupCommand, feedbackCommand, forceSkipCommand, helpCommand, lockCommand, mentionCommand, opinionCommand, popCommand, pushCommand, reloadCommand, resetAfkCommand, rodSquadCommand, rulesCommand, skipCommand, sourceCommand, statusCommand, swapCommand, themeCommand, unhookCommand, unlockCommand, voteRatioCommand, welcomeCommand, whyMehCommand, whyWootCommand, wootCommand, zombieCommand];
  ...
  handleUserJoin = function(user) {
    ...
    if (data.users[user.id].user.relationship < 2) {
      return API.sendChat("/em Welcome to the room, " + user.username + " :wave:");
    }
  };
